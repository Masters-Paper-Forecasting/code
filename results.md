...
This analysis was limited to one kerbside site, London Marylebone Road with Meteorology data from nearby Met Office stations. Marylebone was used because it was the most complete station in the extract, after a nationwide sample was dropped due to incompleteness that was too serve for safe imputation. Training is only about 2.7 years for the same reason, Marylebone before 6 April 2022 failing the completeness cut. Test set is one year, so one cycle of weather.
